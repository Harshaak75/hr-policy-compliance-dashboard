...
import { LayoutDashboard, FileText, Bell, Settings, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function Sidebar({ activePage = "dashboard" }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Sidebar Header */}
      <div className="p-6 border-b" style={{ borderColor: '#E5EAF0' }}>
        {!isCollapsed && (
      ...
      {/* Toggle Button */}
      <div className="p-4 border-t" style={{ borderColor: '#E5EAF0' }}>
        <Button
          variant="ghost"
          size="sm"
